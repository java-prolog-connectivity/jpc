...
public class ReturnSpecifierConstants {
	...
	public static final String BB_REF_TERM_FLAG = "jref"; //black box representation.
	public static final String WB_REF_TERM_FLAG = "jref_term"; //white box representation.
