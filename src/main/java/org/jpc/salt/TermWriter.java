...
public abstract class TermWriter<TermType> extends DefaultTermContentHandler {
	...
	/**
	 * The terms that have been written using this TermWriter
	 * Subclasses may stream each processed term somewhere else (e.g., asserting it in a logic engine) instead of storing them here
	 */
