...
public class LogicEngineWriter extends PrologWriter {
	...
	public void writePrologDirective(Term directive) {
		if(!getLogicEngine().query(directive).hasSolution())
			...
			logger.trace("The directive: " + directive.toString(getLogicEngine()) + " has been executed");
	}
	...
	public void writeLogtalkObjectDirective(Term directive) {
		...
		if(!logtalkObject.perform(directive).hasSolution())
			...
			logger.trace("The logtalk object: " + logtalkObject.asTerm().toString(getLogicEngine()) + " has executed the directive: " + directive.toString(getLogicEngine()));
	}
	...
	public void writePrologClause(Term clause) {
		if(!getLogicEngine().assertz(clause))
			...
			logger.trace("The clause: " + clause.toString(getLogicEngine()) + " has been asserted in the logic database");
	}
	...
	public void writeLogtalkObjectClause(Term clause) {
		try {
			...
			if(!logtalkObject.assertz(clause))
				...
				logger.trace("The clause: " + clause.toString(getLogicEngine()) + " has been asserted in the logtalk object: " + logtalkObject.asTerm().toString(getLogicEngine()));
		} catch(Exception e) {
