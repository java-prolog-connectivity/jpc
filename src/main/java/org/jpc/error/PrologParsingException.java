 ...
 * Unfortunately, there is not (or I do not know) a simple mechanism for converting atoms to terms and 
 *  reporting syntax errors that works reasonably consistently across different Prolog implementations.
 ...
 * Although at first glance it seems like a good idea to throw SyntaxError exceptions wrapping a Prolog error term, apparently this is not easy to port to other Prolog implementations.
